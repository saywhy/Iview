  ...
  <div class="base_info">
    ...
    <div class="info_base">
      <div class="info_base_top">
        <li class="info_top_item" v-if="selectItem.detect_engine=='LOGDF'">
        ...
        <li class="info_top_item" v-for="value in selectItem.info_list" v-if="value.name !='文件行为'&&value.name !='taskID'">
          <span class="info_top_item_title">{{value.name}}</span>
          <span v-if="value.name=='文件大小'">
              {{value.value | filterType }}
            </span>
          <span class="info_top_item_content" v-if="value.name!='文件大小'" :class="value.value=='点击下载'?'download_text':''">
              <span @click="download(value,item)">{{value.value}}</span>
          </span>
        </li>
        <!-- 沙箱检测下载 -->
        <li class="info_top_item" v-for="value in selectItem.info_list" v-if="value.name =='文件行为'">
          <span class="info_top_item_title">{{value.name}}</span>
          <span class="info_top_item_content" :class="value.value=='点击下载'?'download_text':''">
              <span @click="download_sandbox(value,item)"> {{value.value}}</span>
          </span>
        </li>
        <!-- 新添加 -->
        <div class="info_top_item" v-for="value in selectItem.sample_list" v-if="selectItem.sample_list.length!=0">
          <span class="info_top_item_title">{{value.name}}</span>
          <div class="info_top_item_content">
            <p v-for="itemx in value.value" style="padding-bottom: 5px;">{{itemx}}</p>
          </div>
        </div>
      </div>
      <!-- 网络事件 -->
      <div class="info_base_mid">
        ...
        <div class="time_right_net">
          <div class="time_right_net_item" v-for="demo in selectItem.event_list">
      ...
      <div class="info_base_bom">
        <div class="base_bom_left">
          <el-tabs v-model="baseInfo.left_activeName" @tab-click="handleClick" class="reset_tab">
            <el-tab-pane label="情报详情" class="tabs-item" name="1">
              <div class="base_box">
                <div class="base_left_item">
                  <p class="left_item_title">
                    <img src="@/assets/images/emerge/base/base1.png" alt="">
                    <span>地理位置</span>
                  </p>
                ...
                <div class="base_left_item">
                  <p class="left_item_title">
                    <img src="@/assets/images/emerge/base/base2.png" alt="">
                    <span>情报来源</span>
                  </p>
                  <p class="left_item_content">
                    Saic_IPReputation
                ...
                <div class="base_left_item">
                  <p class="left_item_title">
                    <img src="@/assets/images/emerge/base/base3.png" alt="">
                    <span>威胁类型</span>
                  </p>
                  <p class="left_item_content">
                    恶意IP
                ...
                <div class="base_left_item">
                  <p class="left_item_title">
                    <img src="@/assets/images/emerge/base/base4.png" alt="">
                    <span>置信度</span>
                  </p>
                  <p class="left_item_content">
                    85
                ...
                <div class="base_left_item">
                  <p class="left_item_title">
                    <img src="@/assets/images/emerge/base/base5.png" alt="">
                    <span>首次发现时间</span>
                  </p>
                  <p class="left_item_content">
                    2017-03-23
                ...
                <div class="base_left_item">
                  <p class="left_item_title">
                    <img src="@/assets/images/emerge/base/base6.png" alt="">
                    <span>最近发现时间</span>
                  </p>
                  <p class="left_item_content">
                    2019-04-16
            ...
            <el-tab-pane label="IP_whois信息" class="tabs-item" name="2">
              <div class="base_box">
                <div class="base_left_item" v-for="item in selectItem.whois_list">
                  <p class="left_item_title">
                    {{item.name}}
                  </p>
                  <p class="left_item_content">
            ...
            <el-tab-pane label="关联域名" class="tabs-item" name="3">
              关联域名
            </el-tab-pane>
            <el-tab-pane label="关联文件" class="tabs-item" name="4">
              关联文件
            </el-tab-pane>
          </el-tabs>
        </div>
        <div class="base_bom_right">
          <el-tabs v-model="baseInfo.right_activeName" @tab-click="handleClick_right" class="reset_tab">
            <el-tab-pane label="威胁及安全建议" class="tabs-item" name="1">
              <div class="base_box">
                <div class="suggest_bom">
                  <p class="suggest_bom_title">威胁描述</p>
                  <p class="suggest_bom_des" v-for="(item,index) in suggest_list" v-if="index==selectItem.safety_suggestion">{{ item.des}}</p>
                  <p class="suggest_bom_title">安全建议</p>
                  <p class="suggest_bom_list">
                    <img src="@/assets/images/emerge/detail_suggest.png" class="suggest_icon" alt="">
                    <span class="suggest_bom_title">处置建议</span>
                  </p>
                  <div v-for="(item,index)  in suggest_list" v-if="index==selectItem.safety_suggestion">
                    <p class="suggest_bom_li" v-for="it in item.handle">
                      {{it}}
                    </p>
                  </div>
                  <p class="suggest_bom_list">
                  ...
                  <div v-for="(item,index)  in suggest_list" v-if="index==selectItem.safety_suggestion">
                    <p class="suggest_bom_li" v-for="it in item.reinforce">
                      {{it}}
                    </p>
                  </div>
                </div>
