<template>
  <el-col class="vm-main-stage">
    ...
    <div class="attack_stage_center a_right">
      <img  class="a_img" src="@/assets/images/emerge/detail_xiajiantou.png" alt="">
    </div>
    ...
    <div class="attack_stage_center a_left">
      <img class="a_img" src="@/assets/images/emerge/detail_xiajiantou.png" alt="">
    </div>
